CREATE TABLE IF NOT EXISTS TRAVEL_RAW (
  ...
  TPEP_PICKUP_DATETIME      TIMESTAMPTZ                                 COMMENT 'The date and time when the meter was engaged.',
  TPEP_DROPOFF_DATETIME     TIMESTAMPTZ                                 COMMENT 'The date and time when the meter was disengaged.',
